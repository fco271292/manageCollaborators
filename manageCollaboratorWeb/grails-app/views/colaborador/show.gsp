...
<html>
    ...
    <body>
        ...
        <div id="show-colaborador" class="content scaffold-show" role="main">
            ...
            <f:display bean="colaborador" />
            <g:form resource="${this.colaborador}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.colaborador}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
